...
namespace Infrastructure.Persistence.Data.Migrations
{
    ...
    [Migration("20240423151645_AddedMeasureUnitToVariations")]
    partial class AddedMeasureUnitToVariations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ProductVariation", b =>
                {
                    ...
                    b.ToTable("ProductVariations", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_ProductVariations_MeasureUnit", "MeasureUnit IN ('g', 'kg', 'l', 'ml', 'und', 'caja', 'lb', 'botella')");
                        });
                });
